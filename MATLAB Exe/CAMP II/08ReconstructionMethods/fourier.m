...
% calculate 1D FFT of the sinogram
 fftSino = ifftshift(fft(fftshift((sinogram))));
...
% perform coordinate system change
 fftSinoInterp = interp2(cartesianX,cartesianY,fftSino,polarAngle,polarRadius,interpolation,0);

% calculate 2D inverse FFT
 recon = abs(ifftshift(ifft2(fftshift(fftSinoInterp))));
