...
figure(2); imagesc(hist(Image,100)); axis image; title('Image Histogram')
...
tmpfilter = fspecial('gaussian',3,1.5);
Image_nf = imfilter(Image_n,tmpfilter); % Filtered version of "Image_n"
...
Image_PostProcess = medfilt2(Image_nf_km == 2);
